...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"„исло разбиений по X";
			...
			this->label2->Text = L"„исло разбиений по Y";
			// 
			// textBox2
			// 
			...
			this->label3->Text = L"ќграничение шагов";
			// 
			// textBox3
			// 
			...
			this->label4->Text = L"“очность метода";
			// 
			// textBox4
			// 
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		double eps_cur = 0; // дл€ подсчета текущего значени€ прироста
		double error_max = 0; // дл€ подсчета текущего значени€ прироста
		...
		std::vector<double> r((n - 1) * (m - 1)); // нев€зка
		double a = 0, b = 2, c = 0, d = 1; // границы области определени€ уравнени€
		...
		label7->Text = text+L"\n\nћаксимальное отклонение от точного решени€: \n"+(res1.max_diff)+L"\n\n¬ узле: x = "+(res1.x)+ "    y = "+res1.y;
